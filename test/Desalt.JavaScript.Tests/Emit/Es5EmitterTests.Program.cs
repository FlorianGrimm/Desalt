...
namespace Desalt.JavaScript.Tests.Emit
{
    ...
    using AssignOp = Desalt.JavaScript.CodeModels.Expressions.Es5AssignmentOperator;
    using BinaryOp = Desalt.JavaScript.CodeModels.Expressions.Es5BinaryOperator;
