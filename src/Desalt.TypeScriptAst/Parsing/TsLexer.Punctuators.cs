...
namespace Desalt.TypeScriptAst.Parsing
{
    ...
    public sealed partial class TsLexer
    {
        ...
        private TsToken LexPunctuator()
        {
            ...
            // ReSharper disable once SwitchStatementMissingSomeCases
            return _reader.Peek(1) switch
            {
                "{" => new TsToken(TsTokenCode.LeftBrace, _reader.Read(1)!, location),
                "}" => new TsToken(TsTokenCode.RightBrace, _reader.Read(1)!, location),
                "(" => new TsToken(TsTokenCode.LeftParen, _reader.Read(1)!, location),
                ")" => new TsToken(TsTokenCode.RightParen, _reader.Read(1)!, location),
                "[" => new TsToken(TsTokenCode.LeftBracket, _reader.Read(1)!, location),
                "]" => new TsToken(TsTokenCode.RightBracket, _reader.Read(1)!, location),
                "." => new TsToken(TsTokenCode.Dot, _reader.Read(1)!, location),
                ";" => new TsToken(TsTokenCode.Semicolon, _reader.Read(1)!, location),
                "," => new TsToken(TsTokenCode.Comma, _reader.Read(1)!, location),
                "<" => new TsToken(TsTokenCode.LessThan, _reader.Read(1)!, location),
                ">" => new TsToken(TsTokenCode.GreaterThan, _reader.Read(1)!, location),
                "+" => new TsToken(TsTokenCode.Plus, _reader.Read(1)!, location),
                "-" => new TsToken(TsTokenCode.Minus, _reader.Read(1)!, location),
                "*" => new TsToken(TsTokenCode.Asterisk, _reader.Read(1)!, location),
                "/" => new TsToken(TsTokenCode.Slash, _reader.Read(1)!, location),
                "%" => new TsToken(TsTokenCode.Percent, _reader.Read(1)!, location),
                "&" => new TsToken(TsTokenCode.Ampersand, _reader.Read(1)!, location),
                "|" => new TsToken(TsTokenCode.Pipe, _reader.Read(1)!, location),
                "^" => new TsToken(TsTokenCode.Caret, _reader.Read(1)!, location),
                "!" => new TsToken(TsTokenCode.Exclamation, _reader.Read(1)!, location),
                "~" => new TsToken(TsTokenCode.Tilde, _reader.Read(1)!, location),
                "?" => new TsToken(TsTokenCode.Question, _reader.Read(1)!, location),
                ":" => new TsToken(TsTokenCode.Colon, _reader.Read(1)!, location),
                "=" => new TsToken(TsTokenCode.Equals, _reader.Read(1)!, location),
                _ => throw LexException($"Unknown punctuator '{(char)_reader.Read()}'", location)
            };
        }
    }
}
