// ---------------------------------------------------------------------------------------------------------------------
// <copyright file="IScriptPropertySymbol.cs" company="Justin Rockwood">
...
namespace Desalt.Core.SymbolTables
{
    ...
    /// </summary>
    internal interface IScriptPropertySymbol : IScriptSymbol
    {
        /// <summary>
        ...
        /// </summary>
        string CustomInitializationCode { get; }
